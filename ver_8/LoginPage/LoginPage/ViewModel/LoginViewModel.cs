...
namespace LoginPage.ViewModel
{
    public class LoginViewModel : ViewModelBase
    {
        ...
        async Task<bool> IsValidCustomer(int CustId, int password)
        {
            ...
            //  var url = $"https://localhost:7172/customer/helloCustomers";
            using (var client = new HttpClient())
            {
                ...
                //    string _tokenPayload = GetName(_AccessToken);
                //  string _tokenPayload2 = _tokenPayload;
                //Console.WriteLine("The token validation parameters are" + _tokenPayload);
